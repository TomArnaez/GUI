...
Napi::Value gpu_viewport::SetHistogramEqualisation(const Napi::CallbackInfo& info) {
    Napi::Env env = info.Env();
...
Napi::Value gpu_viewport::SetDarkCorrection(const Napi::CallbackInfo& info) {
    Napi::Env env = info.Env();
...
Napi::Value gpu_viewport::SetGainCorrection(const Napi::CallbackInfo& info) {
    Napi::Env env = info.Env();
...
Napi::Value gpu_viewport::SetDefectCorrection(const Napi::CallbackInfo& info) {
    Napi::Env env = info.Env();
